...
📌**个人公众号不能留言，可以加弟哥的微信(**vx:*javasishu1***)，弟哥将为你解答一切问题:**    
>
>**1.你可以向我讲述你的情况，你的困惑，弟哥来给你解答**
>
>**2.我们可以一起规划你的未来** 
>
>**3.你也可以默默的关注弟哥，获得我的第一手资料，包括算法解析、Java资料、脑图、备战路线、offer选择、如何进大厂等**
>
>
> 🚜 **弟哥：可以随时私信我(微信vx:javasishu1)，我会认真帮你解决问题（比如如何学习、学什么、怎么进大厂），不用怕我嫌你烦，弟哥人很好😃**  
>
>下面是弟哥为你准备的学习小屋：包括Java基础、JVM进阶/JVM调优实战，Mysql高性能调优(面试)、Redis底层源码解析、并发编程源码解析、计算机网络基础、git使用教程、Linux系统解析、架构思维、分布式考点，**公众号有更多的一手资源，比如弟哥的成长之路，弟哥如何让这50个师弟进大厂，欢迎关注：弟哥带你进大厂**
